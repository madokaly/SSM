...
<script type="text/javascript">
	function myclose(ispage) {
		window.location="${pageContext.request.contextPath}/prod/product.action?flag=split&ispage="+ispage;
		//window.close();
	}
</script>
			<div id="table">
				<form action="${pageContext.request.contextPath}/prod/update.action" enctype="multipart/form-data" method="post" id="myform">
					...
					<input type="hidden" value="${param.ispage}" name="page">
					<table>
						<tr>
						...
						<tr>
							...
							<td>
								<input type="reset" value="取消" class="btn btn-default" onclick="myclose('${param.ispage}')">
							</td>
						</tr>
					</table>
				</form>
